        ...
        <div class="mt-6">
            ...
            <div id="tab-why" class="tab-panel">
                <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                    ...
                    <p class="mt-3 text-sm text-slate-600">
                        Работим в <strong class="font-semibold text-slate-900">София и региона</strong> с ясно разбиране, че сигурността не е просто техника, а добре обмислена система, съобразена с реалните нужди
